...
export const ROLE_BUCKETS: Partial<Record<UserRole, StageBucket[]>> = {
  [UserRole.DATA_ENTRY]: [
    ...
    { key: 'returned', label: 'مُعادة', statuses: [RequestStatus.BANK_RETURNED] },
  ...
  [UserRole.BANK_ADMIN]: [
    { key: 'pending', label: 'معلّق', statuses: [RequestStatus.SUBMITTED, RequestStatus.BANK_REVIEW, RequestStatus.BANK_RETURNED] },

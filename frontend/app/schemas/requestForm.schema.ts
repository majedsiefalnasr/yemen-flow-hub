...
export const requestFormSchema = z.object({
  ...
  supplier_name: z.string().min(1, 'يرجى إدخال اسم المورد').max(255, 'الاسم طويل جداً'),

  goods_description: z.string().min(1, 'يرجى وصف البضائع'),

  port_of_entry: z.string().min(1, 'يرجى إدخال ميناء الدخول').max(255, 'الاسم طويل جداً'),

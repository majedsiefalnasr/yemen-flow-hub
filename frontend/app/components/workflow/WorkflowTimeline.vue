...
/** History entry that transitioned INTO the current status */
const currentEntry = computed(() =>
  [...props.history].reverse().find(e => e.to_status === props.currentStatus) ?? null,
)
...
const stages = computed((): StageItem[] =>
  WORKFLOW_STAGE_ORDER.map((status, idx) => {
    ...
    >
      ...
      <div class="stage-body">
        ...
        <div class="stage-content">
          ...
          <!-- Current stage: show actor + timestamp from history -->
...
/* Current stage elevated card effect */

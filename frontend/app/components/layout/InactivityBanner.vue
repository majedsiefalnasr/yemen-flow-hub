...
<template>
  <Alert v-if="visible" role="status" aria-live="polite"  class="sticky top-0 z-50 flex items-center justify-between gap-4 border-b border-warning bg-[var(--color-surface-warning)]">

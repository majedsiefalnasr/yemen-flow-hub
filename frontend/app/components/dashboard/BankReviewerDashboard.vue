  ...
  <div class="flex flex-col gap-6" dir="rtl">
    ...
    <template v-else-if="stats">
      ...
      <section aria-labelledby="queue-heading">
        ...
        <Card v-if="queue.length === 0" class="border-0 shadow-card">
        ...
        <Card v-else class="border-0 shadow-card">
          <CardContent class="p-4">
            <table class="w-full border-collapse text-xs" role="table" aria-label="طابور المراجعة الحالي">
              ...
              <tbody>
                <tr v-for="req in queue" :key="req.id" class="border-t border-gray-100 hover:bg-gray-50 cursor-pointer transition-colors">

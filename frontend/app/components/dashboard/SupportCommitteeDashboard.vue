          ...
          <table v-else class="w-full border-collapse text-xs" role="table" aria-label="طابور عملي">
            ...
            <tbody>
              <tr
                ...
                :class="{
                  'bg-blue-50 hover:bg-blue-100': req.is_claimed_by_me,
                  'bg-amber-50 hover:bg-amber-100': !!req.claimed_by && !req.is_claimed_by_me,
                }"
              >
                ...
                <td class="py-2 px-2">
                  <span
                    ...
                    :class="{
                      ...
                      'bg-amber-100 text-amber-700': !!req.claimed_by && !req.is_claimed_by_me,
                      'bg-gray-100 text-gray-700': !req.claimed_by,
                    }"
                  >
                    {{ claimOwnerLabel(req) }}
                  </span>

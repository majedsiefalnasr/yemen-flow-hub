...
## Tasks
Task 1 (V1 report presets): complete — see task-1-v1-presets-report.md
Task 2 (audit widgets optional drop): pending
Task 3 (migrate useUsers): pending
Task 4 (migrate useBanks): complete — f19c5e62
...
- Tasks 6–8 complete this session (see task-6/7/8-report.md + git log)

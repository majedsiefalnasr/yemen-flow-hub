...
use App\Console\Commands\PurgeExpiredTemporaryUploadsCommand;
...
use App\Console\Commands\PurgeOrphanTemporaryUploadsCommand;
...
Schedule::command(PurgeOldIdempotencyKeysCommand::class)->dailyAt('02:15');
...
Schedule::command(PurgeExpiredTemporaryUploadsCommand::class)->dailyAt('02:35');
Schedule::command(PurgeOrphanDocumentsCommand::class)->dailyAt('02:40');
Schedule::command(PurgeOrphanTemporaryUploadsCommand::class)->dailyAt('02:45');

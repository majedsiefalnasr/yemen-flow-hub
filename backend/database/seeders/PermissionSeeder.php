...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['slug' => 'customs.issue', 'name_ar' => 'إصدار وثيقة تأكيد المصارفة الخارجية', 'name_en' => 'Issue external FX confirmation document', 'group' => 'customs'],
            ...
            ['slug' => 'merchants.manage', 'name_ar' => 'إدارة المستوردين', 'name_en' => 'Manage importers', 'group' => 'admin'],

...
class ImportRequestSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ~1200 requests distributed across all 21 canonical RequestStatus values.
        // Skewed toward in-progress states so every role dashboard has substantial load for demo/testing.
        // Includes BANK_RETURNED, SUPPORT_RETURNED, and BANK_REJECTED (Stories 8.1, 8.2, 8.3).
        $plan = [
            ['draft',                              100],
            ['draft_rejected_internal',             40],
            ['submitted',                           80],
            ['bank_review',                        100],
            ['bank_returned',                       30],
            ['bank_rejected',                       20],
        ...
        $this->command?->info("Seeded {$total} import requests covering all 21 canonical workflow statuses.");
    }
}

...
class ImportRequestResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'currency_source' => $this->currency_source?->value,
            'payment_terms_mode' => $this->payment_terms_mode?->value,
            'request_percentage' => $this->request_percentage,
            ...
            'exporting_company_name' => $this->exporting_company_name,
            'exporting_company_location' => $this->exporting_company_location,
            'country_of_origin' => $this->country_of_origin,
            'port_of_loading' => $this->port_of_loading,
            'port_of_arrival' => $this->port_of_arrival?->value,
            ...
            'trader_snapshot_name' => $this->trader_snapshot_name,
            'trader_snapshot_tax_number' => $this->trader_snapshot_tax_number,
            'trader_snapshot_tax_card_expiry' => $this->trader_snapshot_tax_card_expiry?->toDateString(),
            'trader_snapshot_commercial_registration_number' => $this->trader_snapshot_commercial_registration_number,
            'trader_snapshot_commercial_registration_expiry' => $this->trader_snapshot_commercial_registration_expiry?->toDateString(),
            'voting_rule_version' => $this->voting_rule_version,

...
<style>
    * { box-sizing: border-box; }
    ...
    /* Checkbox: nested table approach — reliable in mPDF */
    ...
    table.sig { width: 100%; border-collapse: collapse; font-size: 9pt; margin-top: 10pt; }
    table.sig th, table.sig td { border: 1px solid #b8bec8; padding: 5pt 7pt; vertical-align: top; }
    table.sig th { background-color: #f6f7f9; font-weight: 700; color: #4b5563; text-align: center; }
    table.sig td.seal { height: 50pt; text-align: center; color: #667085; vertical-align: middle; }
    table.sig td.lines td { color: #667085; padding: 3pt 0; border: none; font-size: 9pt; }
    .footer { margin-top: 5pt; padding-top: 4pt; border-top: 1px solid #d6d9df; text-align: center; color: #667085; font-size: 7.5pt; }
</style>
</head>
<body>
...
<h1>طلب وثيقة تأكيد للجمارك</h1>
<div class="rule"></div>

<div class="recipient">الإخوة / اللجنة الوطنية لتنظيم وتمويل الواردات - المحترمون</div>
<div class="intro">بالإشارة إلى الموضوع أعلاه، وبناءً على الآلية المقررة من قبلكم، نرفق أدناه تفاصيل طلب الاستيراد من الخارج حسب البيانات الموضحة والمستندات المرفقة.</div>

{{-- بيانات البنك والتاجر --}}
<div class="section-title">بيانات البنك والتاجر</div>
<table class="dt">
    <tr>
        <th>البنك</th><td>{{ $bankName }}</td>
        <th>اسم المستورد / التاجر</th><td>{{ $merchantName }}</td>
    </tr>
    <tr>
...
{{-- بيانات الشحن والجمارك --}}
<div class="section-title">بيانات الشحن والجمارك</div>
<table class="dt">
    <tr>
...
<div class="footer">Yemen Flow Hub — هذه الوثيقة مخصصة للاستخدام الرسمي ضمن الإجراءات البنكية والجمركية</div>

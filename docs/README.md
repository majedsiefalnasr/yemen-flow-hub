...
| Dashboard architecture       | `architecture/04-dashboard-architecture.md`                                        | planned — not yet written (Step 3B); current authority is AGENTS.md's "Dashboard Architecture" section                                                                                               |
| Request state model          | `architecture/05-request-state-model.md`                                           | planned — not yet written (Step 3B); current authority is AGENTS.md's "Canonical Request State Model" section                                                                                        |

...
| ---------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| System architecture          | `architecture/01-system-architecture.md`                                     | planned — not yet written (Step 3); current authority is [`02-system-architecture.md`](02-system-architecture.md)                                                                                    |
| Workflow engine              | `architecture/02-workflow-engine.md`                                         | planned — not yet written (Step 4); current authority is [`01-workflow-and-business-rules.md`](01-workflow-and-business-rules.md) + [`decisions/semantic-mapping.md`](decisions/semantic-mapping.md) |
| Permission model             | [`architecture/03-permission-model.md`](architecture/03-permission-model.md) | **live**                                                                                                                                                                                             |
| Dashboard architecture       | `architecture/04-dashboard-architecture.md`                                  | planned — not yet written (Step 3); current authority is AGENTS.md's "Dashboard Architecture" section                                                                                                |
| Request state model          | `architecture/05-request-state-model.md`                                     | planned — not yet written (Step 3); current authority is AGENTS.md's "Canonical Request State Model" section                                                                                         |
| Database and models          | `architecture/06-database-and-models.md`                                     | planned — not yet written (Step 3); current authority is [`03-database-and-models.md`](03-database-and-models.md)                                                                                    |
...
| API reference                | `api-reference.md`                                                           | planned — not yet moved (Step 3); current authority is [`06-api-reference.md`](06-api-reference.md)                                                                                                  |

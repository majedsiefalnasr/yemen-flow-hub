...
| Testing guide                | `testing-guide.md`                                                                       | planned — not yet written (Step 12); no current live authority, superseded manual suite archived at [`archive/testing-manual/`](archive/testing-manual/README.md) |
